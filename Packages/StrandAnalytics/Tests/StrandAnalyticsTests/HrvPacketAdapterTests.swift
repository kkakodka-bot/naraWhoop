...
final class HrvPacketAdapterTests: XCTestCase {
    func testNativePacketAdapterRetainsZeroAndDoesNotBorrowOtherTransport() throws {
        ...
        XCTAssertTrue(observations.allSatisfy { $0.userId == "u" && $0.verifiedSpan == nil && $0.deviceFirmware == nil })
        XCTAssertEqual(observations.last?.source, "channel:7", "retaining candidates does not splice them into historical pairs")
