...
final class PushObjectLaneTests: XCTestCase {
    ...
    func testFreshFileRepresentationDoesNotReuseLegacyUploadedContentOnlyCheckpoint() async throws {
        ...
        let transport = FakeObjectTransport(onIntent: { manifest in
            ...
            return .init(objectId: manifest.objectId, objectKey: objectReceiptKey(fresh), uploadUrl: "https://synthetic.example/body",
            ...
            return .init(objectId: object, status: "ready", objectKey: objectReceiptKey(fresh), duplicate: false,
