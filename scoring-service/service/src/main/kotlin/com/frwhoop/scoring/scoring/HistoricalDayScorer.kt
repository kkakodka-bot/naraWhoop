 ...
 */
class HistoricalDayScorer {
    fun score(inputs: HistoricalSignalSampleReader.DayInputs, algorithmVersion: String,
              history: HistoricalStateMachine.Prepared? = null): HistoricalScoreBundle {
        require(algorithmVersion == HistoricalScoringPoller.VERSION) { "Historical scorer cannot impersonate another algorithm" }
        ...
        // non-UTC user (Phase 3 gate failure: "HistoricalDayScorer currently uses a UTC day boundary").
...
data class HistoricalScoreBundle(
