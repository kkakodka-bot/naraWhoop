...
internal object HistoricalObservationWindows {
    fun hourlyHr(input: HistoricalSignalSampleReader.DayInputs): List<HistoricalHourlyObservation> {
    ...
    fun mainNightIndices(input: HistoricalSignalSampleReader.DayInputs, result: DayResult,
    ...
    fun mainNight(input: HistoricalSignalSampleReader.DayInputs, result: DayResult,
