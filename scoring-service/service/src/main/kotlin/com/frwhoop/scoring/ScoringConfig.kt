...
enum class ScoringRunMode { PERSISTENT, REPLAY, INVENTORY, ARCHIVE_ONLY, CHECK_CONFIG }
...
data class ScoringConfig(
    ...
    companion object {
        fun runModeFromArgs(args: Array<String>): ScoringRunMode = when {
            ...
            else -> throw IllegalArgumentException("Use no arguments, --replay-day, --inventory-signals, --archive-only, or --check-config; commands cannot be combined")
        }
