...
Integrate migrations `20260921121000_final_hosted_compute_contract.sql` and
`20260921122000_compute_session_requests.sql`, shared Edge routes and the production worker before
