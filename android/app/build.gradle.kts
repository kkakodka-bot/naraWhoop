...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "NOOP_PUSH_ENDPOINT", publicPushBuildConfig("NOOP_PUSH_ENDPOINT"))
        buildConfigField("String", "NOOP_SUPABASE_ANON_KEY", publicPushBuildConfig("NOOP_SUPABASE_ANON_KEY"))
    }
