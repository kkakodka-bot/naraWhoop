...
/// Server computations use the same personal enrollment as uploads and device linking.
/// Test Centre / developer controls for server HRV/sleep readback sit below enrollment.
struct ServerScoringView: View {
    ...
    var body: some View {
        ScreenScaffold(
            ...
            subtitle: "Enrollment, cached server scores, and field ownership"
        ) {
