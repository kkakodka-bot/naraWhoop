...
export function validateFinalSourceContracts(registry) {
  ...
  const sqlFile = 'supabase/migrations/20260921121000_final_hosted_compute_contract.sql';
  ...
  contains('supabase/migrations/20260921122000_compute_session_requests.sql',
